...
void Atom::peratom_create()
{
  ...
  add_peratom("fp",&fp,DOUBLE,3,1);
  add_peratom("temp",&temp,DOUBLE,0);
  add_peratom("heat",&heat,DOUBLE,0);
  add_peratom("conductivity",&conductivity,DOUBLE,0);
  add_peratom("viscosity",&viscosity,DOUBLE,0);
  add_peratom("phase",&phase,INT,0);
  add_peratom("surface",&surface,INT,0);
...
void Atom::set_atomflag_defaults()
{
  ...
  q_flag = mu_flag = 0;
  fp_flag = temp_flag = heat_flag = conductivity_flag = 0;
  viscosity_flag = phase_flag = 0, surface_flag = 0;
