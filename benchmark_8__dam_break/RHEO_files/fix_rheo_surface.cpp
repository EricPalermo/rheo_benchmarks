...
FixRHEOSurface::FixRHEOSurface(LAMMPS *lmp, int narg, char **arg) :
  Fix(lmp, narg, arg)
{
...
void FixRHEOSurface::post_constructor()
{
...
void FixRHEOSurface::setup_pre_force(int /*vflag*/)
{
  pre_force(0);
}
...
void FixRHEOSurface::init_list(int /*id*/, NeighList *ptr)
{
  list = ptr;
}
...
void FixRHEOSurface::pre_force(int /*vflag*/)
{
...
int FixRHEOSurface::pack_reverse_comm(int n, int first, double *buf)
{
  int i,a,b,k,m,last;
  int dim = domain->dimension;
  int *surface = atom->surface;
...
void FixRHEOSurface::unpack_reverse_comm(int n, int *list, double *buf)
{
  int i,a,b,k,j,m;
  int dim = domain->dimension;
  int *surface = atom->surface;
...
int FixRHEOSurface::pack_forward_comm(int n, int *list, double *buf,
...
void FixRHEOSurface::unpack_forward_comm(int n, int first, double *buf)
{
  int i, k, a, b, m, last;
  int *surface = atom->surface;
  double *rsurf = atom->dvector[index_rsurf];
