...
ComputeStyle(rheo/solids,ComputeRHEOSolids)

#else

#ifndef LMP_COMPUTE_RHEO_SOLIDS_H
#define LMP_COMPUTE_RHEO_SOLIDS_H

#include "compute.h"

namespace LAMMPS_NS {

class ComputeRHEOSolids : public Compute {
 public:
  ComputeRHEOSolids(class LAMMPS *, int, char **);
  ~ComputeRHEOSolids();
  void init();
