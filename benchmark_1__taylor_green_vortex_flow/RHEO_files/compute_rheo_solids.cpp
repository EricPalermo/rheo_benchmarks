...
ComputeRHEOSolids::ComputeRHEOSolids(LAMMPS *lmp, int narg, char **arg) :
...
ComputeRHEOSolids::~ComputeRHEOSolids()
{
...
void ComputeRHEOSolids::init_list(int /*id*/, NeighList *ptr)
{
  list = ptr;
}
...
void ComputeRHEOSolids::compute_peratom()
{
...
int ComputeRHEOSolids::pack_forward_comm(int n, int *list, double *buf,
...
void ComputeRHEOSolids::unpack_forward_comm(int n, int first, double *buf)
{
  int i, k, m, last;
  double *rho = atom->rho;
  double *fx = atom->dvector[index_fx];
...
int ComputeRHEOSolids::pack_reverse_comm(int n, int first, double *buf)
{
  int i,k,m,last;
  double *rho = atom->rho;
...
void ComputeRHEOSolids::unpack_reverse_comm(int n, int *list, double *buf)
{
  int i,k,j,m;
  double *rho = atom->rho;
  int *phase = atom->phase;
...
void ComputeRHEOSolids::correct_v(double *vi, double *vj, double *vi_out, int i, int j)
{
...
double ComputeRHEOSolids::correct_rho(int i, int j) // i is wall, j is fluid
{
...
void ComputeRHEOSolids::store_forces()
{
  double *fx = atom->dvector[index_fx];
  double *fy = atom->dvector[index_fy];
  double *fz = atom->dvector[index_fz];
...
double ComputeRHEOSolids::memory_usage()
{
